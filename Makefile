...
export RAYLIB_NX ?= $(CURDIR)/raylib-nx
...
# include and lib
#---------------------------------------------------------------------------------
LIBDIRS	:= $(PORTLIBS) $(LIBNX) $(RAYLIB_NX)/src
...
ifeq ($(strip $(ICON)),)
icons := $(wildcard $(CURDIR)/*.jpg) $(wildcard $(CURDIR)/*.png)
ifneq (,$(findstring $(TARGET).jpg,$(notdir $(icons))))
export APP_ICON := $(CURDIR)/$(TARGET).jpg
else
ifneq (,$(findstring $(TARGET).png,$(notdir $(icons))))
export APP_ICON := $(CURDIR)/$(TARGET).png
else
ifneq (,$(findstring icon.jpg,$(notdir $(icons))))
export APP_ICON := $(CURDIR)/icon.jpg
else
ifneq (,$(findstring icon.png,$(notdir $(icons))))
